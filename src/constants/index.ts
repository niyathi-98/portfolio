// Companies
import rutgers from '../../public/icons/companies/rutgers.jpeg';
import cognizant from '../../public/icons/companies/cognizant.png';
...
import snowflakeETL from '../../public/photos/projects/snowflake.jpeg';
import ethicate from '../../public/photos/projects/ethicate2.png';
...
import dotnet from '../../public/icons/tech/dotnet.svg';
// Databases
...
import oracle from '../../public/icons/tech/oracle.svg';
...
import mariadb from '../../public/icons/tech/maria.svg';
import dynamodb from '../../public/icons/tech/dynamo.svg';
// Infrastructure
...
//Other
import augrel from '../../public/icons/tech/aug.svg';
...
export const experiences = [
  {
    ...
    points: [
      'Rapid Assess Team(Current): Supported 7+ clients across multiple industries as part of the Rapid Assess Team, delivering 4–8 week accelerated assessments to evaluate current-state environments and cloud readiness.',
      'Provided cross-cloud expertise (AWS/Azure/GCP) to guide clients toward actionable modernization road maps, reducing decision time by up to 40%.  Played a key role in developing and enhancing the internal Rapid Solutions Tool, using Python and SQL to automate assessment workflows and enabling teams to deliver recommendations 2× faster compared to manual analysis.',
      'Major Financial Institution client: Led modernization effort of over 200 servers by managing stakeholder communications to ensure smooth alignment of operations and implementation. Played a key role to discovery process by assisting in a comprehensive assessment of over 600 servers as a part of clients inventory review',
      'Designed and implemented an ETL solution on AWS storing multiple input source data and then visualize it in Amazon Quicksight efficiently. Implemented infrastructure management and versioning of code using Terraform, facilitating the seamless deployment of code and dependencies into AWS leading to a 40% decrease in deployment time',
  ...
  },
  {
    ...
    points: [
      ' Architected and optimized a serverless AWS infrastructure leveraging Step Functions, Lambda, EC2, EventBridge, and SNS to support a text-to-speech conversion model, improving scalability and efficiency.',
      'Refined and tested a speech synthesis model trained on multilingual audio Bible data; developed unit tests using Pytest to ensure data integrity and improve processing efficiency by 50%, while leading a 5-member team and managing deliverables via JIRA for client alignment.',
  ...
  },
  {
    ...
    companyName: 'Cognizant Technnology Solutions',
    icon: infosys,
    date: 'Jan 2021 - April 2022',
    points: [
        'Engineered an end-to-end ETL pipeline leveraging multiple AWS services and Amazon QuickSight for dynamic user dashboards, while maintaining version control in Bitbucket and detailed documentation in Confluence, enhancing team collaboration and improving project delivery timelines by 35%.',
...
export const projects = [
  ...
  // Search Engine
  {
    name: 'Word-Based Search Engine',
    description:
      'Engineered a scalable, high-performance search engine that indexes huge text documents in the order of 10,000+ lines to retrieve search queries quickly in an amortized constant O(1) time. Incorporated Lemmatization techniques to retrieve more generic search results and performed about 20\% faster than a text editor.',    
      techstack: [
      {
        name: 'Python',
        icon: python,
...
export const achievements = [
  ...
  },
  {
    ...
    designation: '#2 Runner up, Energy consumption category',
    image: sih,
